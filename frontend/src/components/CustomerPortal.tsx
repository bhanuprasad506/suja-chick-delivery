...
*Suja Chick Delivery Service* 🚚`;
  ...
  async function submitOrder(e: React.FormEvent) {
    ...
    const finalQuantity = orderForm.quantity;
    ...
    if (!finalQuantity || finalQuantity <= 0) {
      alert('Please enter a valid quantity (minimum 0.5 boxes)');
      return;
    }
        ...
        <div className="max-w-2xl mx-auto relative z-10">
          ...
          <form onSubmit={submitOrder} className="bg-white rounded-3xl shadow-xl p-8 border border-gray-100 hover:shadow-2xl transition-shadow">
            ...
            <div className="grid grid-cols-1 gap-6">
              ...
              {/* Quantity */}
              <div>
                <label className="block text-sm font-semibold text-gray-700 mb-3">📦 {t('form.numberOfBoxes')}</label>
                <input
                  type="number"
                  step="0.5"
                  min="0.5"
                  ...
                  required
                />
                <p className="text-xs text-gray-500 mt-2">Specify the quantity you need</p>
              </div>
        ...
        <div className="text-center mb-10">
          ...
          <div className="absolute top-4 right-4 z-20">
            <button
              ...
              className="px-4 py-2 bg-red-100 hover:bg-red-200 text-red-700 rounded-xl transition-all font-semibold border border-red-200"
            >
              🚪 Logout
            </button>
          </div>
