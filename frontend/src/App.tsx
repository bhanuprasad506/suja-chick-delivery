          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
            ...
            {(selectedDelivery.customerPhone || selectedDelivery.orderId) && (
              <div className="bg-gradient-to-br from-purple-50 to-pink-50 p-6 rounded-xl border border-purple-200 mb-8">
                <h3 className="font-bold text-purple-900 mb-4 text-lg">👤 Customer Information</h3>
            ...
            <div className="bg-red-50 border-2 border-red-200 rounded-xl p-6 mb-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="bg-white p-4 rounded-lg border border-red-200">
                  <h4 className="font-semibold text-gray-800 mb-2">Delete All Deliveries</h4>
                ...
                {/* Delete by Date */}
                <div className="bg-white p-4 rounded-lg border border-red-200">
                  <h4 className="font-semibold text-gray-800 mb-2">Delete by Date</h4>
                  ...
                  <div className="flex justify-between items-start">
                    ...
                    <div className="text-right">
                      ...
                      <button
                        ...
                        className="mt-2 px-3 py-1 bg-orange-100 hover:bg-orange-200 text-orange-700 rounded-lg transition-all text-sm font-semibold"
                      >
                        ✏️ Edit
                      </button>
                    </div>
          ...
          {deliveries.length > 0 && (
            <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="bg-gradient-to-br from-blue-50 to-cyan-50 p-4 rounded-lg border-l-4 border-blue-500 text-center">
                <p className="text-sm text-gray-700 font-semibold mb-2">📊 Total Loaded Weight</p>
              ...
              <div className="bg-gradient-to-br from-red-50 to-pink-50 p-4 rounded-lg border-l-4 border-red-500 text-center">
                <p className="text-sm text-gray-700 font-semibold mb-2">📊 Total Empty Weight</p>
